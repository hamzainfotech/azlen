...
<head>
  ...
  <?php if(empty( $_GET['video_name'])) $page = Null ?>
  ...
  <div class="row" style="width: 98%">
    ...
    <div class="clearfix">&nbsp;</div>
      <div class="row">
        ...
        <?php 
       $rows =mysqli_query($con,"SELECT * FROM videos where catid=$page ORDER BY ordr" ) or die(mysqli_error($con));
    $n=0;
