...
<?php if (!empty($page)) {
        ...
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix">
            <div class="heading" style="text-transform: capitalize;">
              <i class="fa fa-book"></i> <?php echo $page ?>
            </div>
                ...
                while($row=mysqli_fetch_array($rows)){
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td style="">
                        <a href="../pdf/<?php echo $img ?>" target="_blank" class="form-control" ?> <?php echo $img ?></a>
                      </td>
                      <td>
                        <input id="ccatimg1" accept="application/pdf"  type="file" class="form-control" name="img<?php echo $n ?>">
                      </td>
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td colspan="2">
                        <input type="file" accept="application/pdf" class="form-control" name="img" >
  ...
  <?php } ?>
    ...
    <div class="container-fluid main-content" style="display: none">
      <div class="row">
        <!-- Basic Table -->
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix">
                ...
                while($row=mysqli_fetch_array($rows)){
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td>
                        <img id="catimg" src="../pdf/<?php echo $img ?>" class="form-control" ?>
                      </td>
                      <td>
