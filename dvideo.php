...
<head>
  ...
  <?php if(!empty( $_GET['dvideo_name'])) $page = $_GET['dvideo_name'] ?>
  <?php if(empty( $_GET['page_name'])) $link = Null ?>
  <?php if(empty( $_GET['dvideo_name'])) $page = Null ?>
...
<body class="body-wrapper">
  ...
  <div class="row" style="width: 98%">
    ...
    while($row=mysqli_fetch_array($rows)){
      ...
      $name = $row['name'];
      $id = $row['id'];?>
      <a class="sidelink" href="videos-<?php echo $id ?>"> <?php echo $name ?></a> <br>
    <?php } ?>
  </div>
    ...
    <div class="clearfix">&nbsp;</div>
      <div class="row">
        ...
        <?php 
       $rows =mysqli_query($con,"SELECT * FROM videos where id=$page ORDER BY ordr" ) or die(mysqli_error($con));
    $n=0;
